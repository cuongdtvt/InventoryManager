	...
	<div class="">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				...
				<div class="x_content">
					<a href="<c:url value="/goods-issue/add"/>" class="btn btn-app"><i class="fa fa-plus"></i>Thêm</a>
					<a href="<c:url value="/goods-issue/export"/>" class="btn btn-app"><i class="fa fa-cloud-download"></i>Xuất File</a>
