	...
	<div class="">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				...
				<div class="x_content">
					<a href="<c:url value="/goods-receipt/add"/>" class="btn btn-app"><i class="fa fa-plus"></i>Thêm</a>
					<a href="<c:url value="/goods-receipt/export"/>" class="btn btn-app"><i class="fa fa-cloud-download"></i>Xuất File</a>
					<div class="container" style="padding: 50px;">
						<form:form modelAttribute="searchForm" cssClass="form-horizontal form-label-left" servletRelativeAction="/goods-receipt/list/1" method="POST">
							...
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="fromDate">Từ Ngày</label>
								<div class="col-md-6 col-sm-6 col-xs-12 ">
							...
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="toDate">Đến Ngày</label>
								<div class="col-md-6 col-sm-6 col-xs-12 ">
						...
						<table class="table table-striped jambo_table bulk_action">
							<thead>
								<tr class="headings">
									...
									<th class="column-title no-link last text-center" colspan="3"><span class="nobr">Hành Động</span></th>
								</tr>
							</thead>
